...
* ## Developing Solutions
  ...
  * ```python
    ...
    # this method accepts user input. It takes input for
    # a ticker. If the ticker doesnt exist it exits. Otherwise 
    # it takes input for a key and value, and preformats 
    # them. It then sends this data to the update function.
    # On return, it reports on whether the update worked.
...
There is a menue module and the fifteen modules which it calls. 
