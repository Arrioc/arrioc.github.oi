...
test and code uniform resource identifiers (URI’s) and locators (URLs) which are paths that allow for high level functionality using an HTTP connection. For the project we will use client side URL’s or CURLS.
